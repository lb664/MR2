# 135 characters #####################################################################################################################
#' @title Simulated scenario: Dependence
...
#' dependence between the responses not due to any unmeasured pleiotropic pathway
#'
...
#'         thetaSparsness, heritY, rhoX, betaXRange, heritX, rhoX, thetaUY, thetaUX, std, seed)} } }
#'
#' @references
#' \insertAllCited{}
#'
...
Scenario_Dependence <- function(nRep = 2, q = 5, p = 10, nIV = 100, nSubject = 50000, MAF = 0.05, 
